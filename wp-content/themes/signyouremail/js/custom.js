...
$('.addon-meeting').click(function(){
    $('.installed-addons').append('<div class="card card-item is-stacked is-active addon-meeting-hide"><header role="tab" aria-expanded="false" class="card-header touchable drag-handle has-danger-bg is-uppercase show-content"><h3 class="card-header-title">mobileApp</h3> <span class="card-header-button"><a class="button is-dark is-small"><span class="icon is-small"><i class="icon-pencil"></i></span><span>EDIT</span></a> <a class="button is-dark is-small remove-addon-this remove-addon-meeting"><span class="icon is-small"><i class="icon-trash-o"></i></span><span>REMOVE</span></a></span></header> <div style="display: none;" class="show-content-edit"><div class="card-content"><div class="card-content-box"><div><div class="field"><label class="label">Call To Action</label> <p class="control"><input type="text" placeholder="Call To Action" class="input"></p></div> <div class="field"><label class="label"><span>Android App</span><br></label> <div class="columns"><div class="column is-narrow"><img src="https://s3.amazonaws.com/signmyemails/assets/site/google_play_badge.png" alt="" style="width: 100%; max-width: 130px;"></div> <div class="column"><p class="control"><input type="text" placeholder="Android App Url" class="input"></p></div></div></div> <div class="field"><label class="label"><span>IOS App</span><br></label> <div class="columns"><div class="column is-narrow"><img src="https://s3.amazonaws.com/signmyemails/assets/site/app_store_badge.png" alt="" style="width: 100%; max-width: 130px;"></div> <div class="column"><p class="control"><input type="text" placeholder="IOS App Url" class="input"></p></div></div></div></div></div></div> <!----></div></div>');
    $('.remove-addon-this').click(function(){
...
// addon banner images in right side append
$("body").on('click', '.addon-banner', function() {
  $('.add-banner-get').append('<tr class="removehidebanner"><td valign="top" style="padding: 10px 0px;"><a href="https://www.google.com" name="bannerimglink" class="banner-img-link"><img id="mybannerimg" class="bannerimg show-banner-img" src="https://cdn.signmyemails.com/images/avatar.png" style="display: none; max-height: 75px; background: rgb(255, 255, 255);"></a></td></tr>');
});
// remove button click and remove content right side div 
$('body').on('click','.remove-addon-banner', function(){
  alert('remove banner');
  $('.removehidebanner').remove();
});
...
function readURLbanner(input) {
  if (input.files && input.files[0]) {
    ...
    reader.onload = function(e) {
      ...
      $('.show-banner-img').css('display', 'block'); 
    }   
    reader.readAsDataURL(input.files[0]);
  }
}
...
// banner append a link
$("body").on('keyup', '[name="banner_link"]',function(){
  var bannerimglink = $(this).val();
  $('.banner-img-link').attr("href", bannerimglink);
});



// addon badges images in right side append
$("body").on('click', '.addon-badges', function() {
  $('.add-banner-get').append('<tr class="removehidebadges"><td valign="top" style="padding: 5px 0px;"><table cellpadding="0" cellspacing="0" border="0" style="font-family: sans-serif; border-collapse: collapse; color: #333; line-height: 1.5; width: auto;"><tbody><tr class=""><a href="" class="badgesimglink"><img class="badgesimg show-badges-img" src="https://cdn.signmyemails.com/images/avatar.png" style="display: none;max-height: 75px; background: rgb(255, 255, 255);"></a></tr></tbody></table></td></tr>');  
});

// remove button click and remove content right side div 
$('body').on('click','.remove-addon-badges', function(){
  alert('remove badges');
  $('.removehidebadges').remove();
});

// upload badges images
function readURLbadges(input) {
  if (input.files && input.files[0]) {
    var reader = new FileReader();
    reader.onload = function(e) {
      $('.badgesimg').attr('src', e.target.result);
      $('.show-badges-img').css('display', 'block'); 
    }   
    reader.readAsDataURL(input.files[0]);
  }
}
$("body").on('change', '.badgesimgipload', function() {
  readURLbadges(this);
});

// badges append a link
$("body").on('keyup', '[name="badge_link"]',function(){
